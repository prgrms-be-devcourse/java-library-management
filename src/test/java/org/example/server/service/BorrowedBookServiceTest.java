...
import org.example.server.entity.bookStatus.BorrowedStatus;
...
public class BorrowedBookServiceTest {
    ...
    @BeforeEach
    @DisplayName("서비스 초기화 및 대여중인 책 생성")
    void initService() {
        repository = mock(Repository.class);
        service = new BookService(repository);

        type = new BorrowedStatus().getType();
