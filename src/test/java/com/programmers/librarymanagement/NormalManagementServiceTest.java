...
public class NormalManagementServiceTest {
    ...
    static NormalBookRepository normalBookRepository;

    @BeforeAll
    static void injectRepository() {
        normalBookRepository = new NormalBookRepository();
        libraryManagementService = new LibraryManagementService(normalBookRepository);
    }
    ...
    void successFindByTitle() {
        ...
        // then
        List<Book> bookList = normalBookRepository.findByTitle("살아남기"); // 데브코스에서 살아남기, 인프런에서 살아남기 1, 인포런에서 살아남기 2
