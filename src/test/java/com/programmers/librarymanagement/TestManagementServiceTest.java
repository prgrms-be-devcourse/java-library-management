...
public class TestManagementServiceTest {
    ...
    void successReturnBook() {
        ...
        // then
        Assertions.assertEquals(testBookRepository.findById(bookNum).get().getStatus(), ARRANGE);
    }
    ...
    void successLostBook() {
        ...
        // then
        Assertions.assertEquals(testBookRepository.findById(bookNum).get().getStatus(), LOST);
    }
    ...
    void successDeleteBook() {
        ...
        // then
        Assertions.assertFalse(testBookRepository.findById(bookNum).isPresent());
    }
