...
public class ConsoleView implements View{
    ...
    public NumberDTO selectMode() throws IOException {
        System.out.println("\nQ. 모드를 선택해주세요.\n" +
                "1. 일반 모드\n" +
                "2. 테스트 모드\n");
        return NumberDTO.builder().number(Integer.parseInt(br.readLine())).build();
    }
    ...
    public BookInfoDTO addBook() throws IOException {
        ...
        return BookInfoDTO.builder().title(title).author(author).pageNum(pageNum).build();
    }
    ...
    public BookInfoDTO searchBook() throws IOException {
        ...
        String title = br.readLine();
        return BookInfoDTO.builder().title(title).build();
    }
